...
#define TEST_APPLICATION_REDUCED_MEMORY  //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
...
#define DEVICE_PROFILE_TYPE                       0x00005001
#endif

/** 
DEVICE_NAME: Name of the slave device (Object 0x1008) */
#ifndef DEVICE_NAME
#define DEVICE_NAME                               "Renesas EtherCAT RZ/N2 FoE 2port"
#endif
