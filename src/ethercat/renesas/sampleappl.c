...
void APPL_SetLed(UINT16 value)
{
	...
	R_BSP_PinWrite((bsp_io_port_pin_t)leds.p_leds[SAMPLE_LED_RLED0], pin_level[SAMPLE_LED_RLED0]);
	R_BSP_PinWrite((bsp_io_port_pin_t)leds.p_leds[SAMPLE_LED_RLED1], pin_level[SAMPLE_LED_RLED1]);

#if defined(BOARD_RZT2M_RSK) | defined(BOARD_RZN2L_RSK)
	R_BSP_PinWrite((bsp_io_port_pin_t)leds.p_leds[SAMPLE_LED_RLED2], pin_level[SAMPLE_LED_RLED2]);
	R_BSP_PinWrite((bsp_io_port_pin_t)leds.p_leds[SAMPLE_LED_RLED3], pin_level[SAMPLE_LED_RLED3]);
#endif
...
UINT16 APPL_GetDipSw(void)
{
	...
	if (R_BSP_PinRead((bsp_io_port_pin_t)dipsws.p_sws[SAMPLE_DIPSW_0]) == BSP_IO_LEVEL_LOW) u16DipSw |= 0x01;
	if (R_BSP_PinRead((bsp_io_port_pin_t)dipsws.p_sws[SAMPLE_DIPSW_1]) == BSP_IO_LEVEL_LOW) u16DipSw |= 0x02;
	if (R_BSP_PinRead((bsp_io_port_pin_t)dipsws.p_sws[SAMPLE_DIPSW_2]) == BSP_IO_LEVEL_LOW) u16DipSw |= 0x04;
	if (R_BSP_PinRead((bsp_io_port_pin_t)dipsws.p_sws[SAMPLE_DIPSW_3]) == BSP_IO_LEVEL_LOW) u16DipSw |= 0x08;

#if defined(BOARD_RZT2M_RSK)
	if (R_BSP_PinRead((bsp_io_port_pin_t)dipsws.p_sws[SAMPLE_DIPSW_4]) == BSP_IO_LEVEL_LOW) u16DipSw |= 0x10;
	if (R_BSP_PinRead((bsp_io_port_pin_t)dipsws.p_sws[SAMPLE_DIPSW_5]) == BSP_IO_LEVEL_LOW) u16DipSw |= 0x20;
	if (R_BSP_PinRead((bsp_io_port_pin_t)dipsws.p_sws[SAMPLE_DIPSW_6]) == BSP_IO_LEVEL_LOW) u16DipSw |= 0x40;
	if (R_BSP_PinRead((bsp_io_port_pin_t)dipsws.p_sws[SAMPLE_DIPSW_7]) == BSP_IO_LEVEL_LOW) u16DipSw |= 0x80;
#endif
